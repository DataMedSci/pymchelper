...
res_dir = os.path.join("tests", "res", "shieldhit", "diff_scoring")
...
def test_log_diff_axis_is_detected_as_logarithmic():
    ...
    estimator = fromfile(os.path.join(res_dir, "fluence_elog.bdo"))
...
def test_lin_diff_axis_is_detected_as_linear():
    ...
    estimator = fromfile(os.path.join(res_dir, "fluence_elin.bdo"))
    diff_axis = estimator.pages[0].diff_axis1
