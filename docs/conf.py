...
latex_documents = [
    (master_doc, 'pymchelper.tex', 'pymchelper Documentation',
     'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'pymchelper', 'pymchelper Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pymchelper', 'pymchelper Documentation',
     author, 'pymchelper', 'One line description of project.',
     'Miscellaneous'),
]
