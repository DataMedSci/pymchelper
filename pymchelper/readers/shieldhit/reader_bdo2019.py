...
from pymchelper.readers.shieldhit.binary_spec import SHBDOTagID, detector_name_from_bdotag, unit_name_from_unit_id, \
    page_tags_to_save
from pymchelper.readers.shieldhit.reader_base import SHReader, read_next_token, _get_mesh_units
...
class SHReaderBDO2019(SHReader):
    ...
    def read_data(self, estimator):
        ...
        with open(self.filename, "rb") as f:
            ...
            _, xname = _get_mesh_units(estimator, 0)
            _, yname = _get_mesh_units(estimator, 1)
            _, zname = _get_mesh_units(estimator, 2)
