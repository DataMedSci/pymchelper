...
from pymchelper.readers.shieldhit.binary_spec import SHBDOTagID, detector_name_from_bdotag, unit_name_from_unit_id, \
    page_tags_to_save
from pymchelper.readers.shieldhit.reader_base import SHReader, read_next_token, mesh_name_and_unit
...
class SHReaderBDO2019(SHReader):
    ...
    def read_data(self, estimator):
        ...
        with open(self.filename, "rb") as f:
            ...
            _, xname = mesh_name_and_unit(estimator, 0)
            _, yname = mesh_name_and_unit(estimator, 1)
            _, zname = mesh_name_and_unit(estimator, 2)
