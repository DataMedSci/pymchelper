...
find_python_interpreter() {
    ...
    for PYTHON_INTERPRETER in python3.8 python3.7 python3.6 python3.5 python3 python
    do
...
make_zipapp() {
    ...
    $GOOD_PYTHON_INTERPRETER -m zipapp $EXENAME -p "/usr/bin/env python" -m $ENTRYPOINT -c 
